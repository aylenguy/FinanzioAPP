...
import {
  ...
  BarChart2, Target, LogOut, LucideIcon, X,
} from "lucide-react";
    ...
    <div className="flex flex-col h-full bg-white">
      <div className="px-5 py-5 border-b border-gray-100 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 bg-blue-600 rounded-lg flex items-center justify-center text-white text-sm font-bold">F</div>
          <div>
      ...
      <div className="px-5 py-4 border-t border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <button onClick={handleLogout} className="text-gray-300 hover:text-red-400 transition-colors flex-shrink-0">
            <LogOut size={15} />
          </button>
        </div>
      </div>
    ...
    <>
      ...
      {open && (
        <div className="md:hidden fixed inset-0 z-50 flex">
          ...
          <aside className="relative w-64 h-full shadow-xl z-10">
